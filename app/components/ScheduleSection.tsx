...
export function ScheduleSection() {
  return (
    <section id="book-a-call" className="scroll-mt-24 py-12 sm:py-20">
      <div className="mx-auto max-w-[1120px] px-4 sm:px-6">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-14">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--color-brass)]">
              Direct with Vijay
            </p>
            <h2 className="mt-3 font-serif text-[clamp(1.55rem,5vw,2.35rem)] leading-tight text-[var(--color-ink)]">
              Ready to find out what&apos;s actually broken?
            </h2>
            <div className="mt-5 h-px w-14 bg-[var(--color-brass)]" />
            <p className="mt-6 max-w-md text-[15px] leading-relaxed text-[var(--color-muted)] sm:text-[15.5px]">
