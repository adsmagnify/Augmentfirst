  ...
  return (
    <section className="py-8 sm:py-12">
      <div className="mx-auto max-w-[760px] px-4 text-center sm:px-6">
        <h2 className="font-serif text-[clamp(1.35rem,5vw,1.85rem)] text-[var(--color-ink)]">
          This isn&apos;t for every organisation.
        </h2>
        <div className="mx-auto mt-4 h-px w-14 bg-[var(--color-brass)]/70" />
        <p className="mt-5 text-[15px] leading-relaxed text-[var(--color-muted)] sm:text-[15.5px]">
