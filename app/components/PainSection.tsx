export function PainSection() {
  return (
    <section className="relative border-y border-[var(--color-hairline)] bg-[var(--color-panel)]/40 py-12 sm:py-20">
      <div className="mx-auto max-w-[760px] px-4 text-center sm:px-6">
        <h2 className="font-serif text-[clamp(1.45rem,5vw,2.15rem)] leading-snug text-[var(--color-ink)]">
          You already know this feeling.
        </h2>
        <div className="mx-auto mt-5 h-px w-16 bg-[var(--color-brass)]/70" />
        <p className="mt-6 text-[15px] leading-[1.75] text-[var(--color-muted)] sm:mt-7 sm:text-[17px]">
        ...
        <p className="mt-5 text-[15px] leading-[1.75] text-[var(--color-ink)]/90 sm:text-[17px]">
