...
export function Header() {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-black/[0.06] bg-white">
      <div className="mx-auto flex max-w-[1200px] items-center justify-between px-6 py-4.5">
        <Logo />
        <a
          href="tel:+4407784419117"
          className="flex items-center gap-2 text-[13.5px] font-semibold text-[#16233f] transition hover:text-[var(--color-gold)]"
        >
